...
async def main():
    url = "https://store.steampowered.com/search/results/?query&start=0&count=50&dynamic_data=&sort_by=_ASC&term=action_fps&snr=1_7_7_151_7&supportedlang=english&infinite=1"
